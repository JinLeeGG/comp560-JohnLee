"""
Training loop for the from-scratch micro-transformer (relative-order task).

Same engine and structure as generalization-detect; only the data dir and task naming
differ. Two deliberate departures from the nanoGPT flat-stream baseline (see the spec):
