...
What to look for: learned/sinusoidal have high validation accuracy but chance held-out
...
What to look for: this shows whether a 50% model is just predicting one label.
...
What to look for: the train block is positions `0,1,2`; the held-out block is
